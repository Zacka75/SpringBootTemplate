...
public class RouteURLFilter extends ZuulFilter {
	...
	Logger log = LoggerFactory.getLogger(RouteURLFilter.class);
	...
	public int filterOrder() {
		return 2;//FilterConstants.SEND_RESPONSE_FILTER_ORDER; // SIMPLE_HOST_ROUTING_FILTER_ORDER
	}
	...
	public String filterType() {
		return "route";//FilterConstants.ROUTE_TYPE;
	}
